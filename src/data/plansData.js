...
export const plansData = {
  ...
  netflix: [
    ...
    },
    {
      ...
      price: '?1899',
      plan: 'Netflix-12M-1899'
    }
  ],
  canva: [
    {
      title: 'LifeTime Canva Pro',
      features: [
        'LifeTime Pro Access',
        'Private Premium Account',
        'Premium Templates + Stock',
        '3 Years Support Assistance'
      ],
      price: '?399',
      plan: 'Canva-12M-399',
      popular: true
  ...
  capcut: [
    {
      ...
      price: '?499',
      plan: 'CapCut-Pro-1M-499',
      popular: true,
      tag: 'Most Popular'
    },
    {
      title: 'CapCut Pro - 3 Months',
      features: [
        '?? Professional Video Editing',
        '?? No Watermark Export',
        '?? Premium Effects & Templates',
    ...
    },
    {
      ...
      price: '?2399',
      plan: 'CapCut-Pro-6M-2399'
    },
    {
      title: 'CapCut Pro - 12 Months',
      features: [
        '?? Professional Video Editing',
        '?? No Watermark Export',
        '?? Premium Effects & Templates',
  ...
  chatglm: [
    {
      ...
      features: [
        ...
        '??? Unlimited video generation up to 4K 60 FPS',
        '?? Per render length: 10 sec per generation',
        '??? Unlimited image generation (VIP)',
        '?? No watermark on videos & images',
        '? Priority queue for faster renders',
        '?? Latest model updates included',
        '?? Shared access (mobile + desktop)',
        '?? Natural sound only - No human voice/dialogues (China-based tool)',
  ...
  cursor: [
    {
      ...
      features: [
        ...
        '? Fast code generation & refactoring',
        '?? Explain, fix & optimize code instantly',
    ...
    },
    {
      ...
      features: [
        ...
        '?? Better long-context code understanding',
        '?? Faster responses under heavy load',
        '?? Private & dedicated account',
        '?? Priority support',
        '?? Built for power users & agencies'
      ],
      price: '?2999',
  ...
  claude: [
    {
      ...
      note: '?? Not an official Claude or OpenAI subscription. Access provided via alternative method. 3rd party provider: Rovodev (Atlassian). Special first-time purchase offer: ?1999 ? ?999.',
      accent: true
    },
    {
      ...
      note: '?? Not an official Claude or OpenAI subscription. Access provided via alternative method. 3rd party provider: Rovodev (Atlassian).',
      accent: true
    },
    {
  ...
  perplexity: [
    {
      title: '1 Month Perplexity Pro',
      features: [
        '?? 600+ Pro Searches',
        '?? GPT-4, Claude, Gemini & more',
        '?? Upload & analyze files',
        '?? Unlimited quick searches',
        '?? Service subject to Perplexity T&Cs'
      ],
      price: '?499',
  ...
  spotify: [
    {
      ...
      features: [
        ...
        '?? Offline Downloads',
        '?? Private Account on Client Email',
        '?? All Devices Supported',
        '?? High Quality Audio',
        '?? Unlimited Skips'
      ],
      price: '?99',
      plan: 'Spotify-Premium-2M-99',
      popular: true
    },
    {
  ...
  descript: [
    {
      ...
      features: [
        '?? Edit Videos & Podcasts Like a Text Doc',
  ...
  openart: [
    {
      ...
      features: [
        ...
        '??? Access to 100+ Premium Image, Video & Audio Models',
    ...
    },
    {
      ...
      features: [
        ...
        '??? 100+ Premium Models (Image, Video, Audio)',
        '?? One-Click Story Creation',
        '?? Private Account Access',
        '?? Priority Support'
      ],
  ...
  bolt: [
    {
      ...
      features: [
        ...
        '??? PromptBox for Better AI Control',
  ...
  notion: [
    {
      ...
      features: [
        ...
        '? 6 Months Support Assistance Included'
      ],
      price: '?2999',
  ...
  emergent: [
    {
      ...
      features: [
        ...
        '? 12-Month Support Assistance Included',
  ...
  grok: [
    {
      ...
      features: [
        ...
        '🚀 Grok 4.1 - Fast & Expert mode',
        '🎨 Unlimited Image Generation',
        '🎥 Unlimited Video Generation',
        '📹 Imagine 1.0 - longer, 720p videos',
        '🎤 Longer Voice Mode & Companion chats',
        '⚡ Priority access during peak times',
        '🆕 Early access to new features',
        '✅ Official SuperGrok Plan',
        '💰 Original Price: ₹700/month',
        '🎯 Your Price: Only ₹399/month',
        '🔥 Best Value AI Tool'
      ],
      price: '₹399',
      originalPrice: '₹700',
      plan: 'Grok-1M-399',
      note: '✅ 1 Month Access • Unlimited Image & Video • Best Price 🔥'
    }
  ]
}
